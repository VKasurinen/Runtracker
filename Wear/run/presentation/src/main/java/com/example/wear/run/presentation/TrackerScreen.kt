...
import com.example.core.presentation.designsystem.ExclamationMarkIcon
import com.example.core.presentation.designsystem.FinishIcon
...
fun TrackerScreenRoot(
    ...
    LaunchedEffect(state.isRunActive, state.hasStartedRunning, ActiveRunService.isServiceActive) {
